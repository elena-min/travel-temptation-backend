...
class TrendingServiceTest {
    ...
    void getTrendingExcursion() {
        ...
        List<ExcursionEntity> excursionEntities = Arrays.asList(
                new ExcursionEntity(1L, "Excursion 1", "Paris, Bora Bora","description", startDate, endDate, travelAgency, 100.0, 50, 50, "file"),
                new ExcursionEntity(2L, "Excursion 2", "London, Amsterdam","description", startDate, endDate, travelAgency, 200.0, 40, 40, "file")
        );
